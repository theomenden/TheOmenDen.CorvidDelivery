...
namespace TheOmenDen.CorvidDelivery.TiltifyApi.Models {
    public class Target : IAdditionalDataHolder, IParsable {
        /// <summary>Whether or not the target is active</summary>
        public bool? Active { get; set; }
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Amount to hit this target</summary>
...
#nullable restore
        ...
        public Money Amount { get; set; }
#endif
        /// <summary>Amount Raised by this target</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public Money AmountRaised { get; set; }
#endif
        /// <summary>Moment when the target ends</summary>
        public DateTimeOffset? EndsAt { get; set; }
        /// <summary>Unique Identifier for the target.</summary>
        public Guid? Id { get; set; }
        /// <summary>Moment when the target was created</summary>
...
#nullable restore
        ...
        public string Name { get; set; }
#endif
        /// <summary>Moment when the target was last updated</summary>
        public DateTimeOffset? UpdatedAt { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="Target"/> and sets the default values.
        /// </summary>
        public Target() {
        ...
        /// </summary>
        /// <returns>A <see cref="Target"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Target CreateFromDiscriminatorValue(IParseNode parseNode) {
