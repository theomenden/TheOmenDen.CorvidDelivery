...
namespace TheOmenDen.CorvidDelivery.TiltifyApi.Models {
    public class WebhookRelayDonation : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public WebhookRelayDonation_payment_status? PaymentStatus { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="WebhookRelayDonation"/> and sets the default values.
        /// </summary>
        public WebhookRelayDonation() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="WebhookRelayDonation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WebhookRelayDonation CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WebhookRelayDonation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"payment_status", n => { PaymentStatus = n.GetEnumValue<WebhookRelayDonation_payment_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<WebhookRelayDonation_payment_status>("payment_status", PaymentStatus);
