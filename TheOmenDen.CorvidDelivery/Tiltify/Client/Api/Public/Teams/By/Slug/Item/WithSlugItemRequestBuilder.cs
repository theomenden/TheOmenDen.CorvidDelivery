...
namespace TheOmenDen.CorvidDelivery.TiltifyApi.Api.Public.Teams.By.Slug.Item {
    /// <summary>
    /// Builds and executes requests for operations under \api\public\teams\by\slug\{slug}
    /// </summary>
    public class WithSlugItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithSlugItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/public/teams/by/slug/{slug}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="WithSlugItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSlugItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/public/teams/by/slug/{slug}", rawUrl) {
        }
        /// <summary>
