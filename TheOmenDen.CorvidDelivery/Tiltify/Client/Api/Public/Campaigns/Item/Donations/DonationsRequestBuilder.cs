...
namespace TheOmenDen.CorvidDelivery.TiltifyApi.Api.Public.Campaigns.Item.Donations {
    /// <summary>
    /// Builds and executes requests for operations under \api\public\campaigns\{campaign_id}\donations
    /// </summary>
    public class DonationsRequestBuilder : BaseRequestBuilder {
        ...
        public DonationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/public/campaigns/{campaign_id}/donations{?after*,before*,completed_after*,completed_before*,limit*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="DonationsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DonationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/public/campaigns/{campaign_id}/donations{?after*,before*,completed_after*,completed_before*,limit*}", rawUrl) {
        }
        /// <summary>
        /// List donations
        /// </summary>
