...
namespace TheOmenDen.CorvidDelivery.TiltifyApi.Api.Public.Campaigns.Item.Milestones {
    /// <summary>
    /// Builds and executes requests for operations under \api\public\campaigns\{campaign_id}\milestones
    /// </summary>
    public class MilestonesRequestBuilder : BaseRequestBuilder {
        ...
        public MilestonesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/public/campaigns/{campaign_id}/milestones{?after*,before*,created_after*,created_before*,include_disabled*,limit*,updated_after*,updated_before*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="MilestonesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MilestonesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/public/campaigns/{campaign_id}/milestones{?after*,before*,created_after*,created_before*,include_disabled*,limit*,updated_after*,updated_before*}", rawUrl) {
        }
        /// <summary>
        /// List milestones
        /// </summary>
