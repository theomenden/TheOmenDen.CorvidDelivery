...
namespace TheOmenDen.CorvidDelivery.Twitch.Moderation.Blocked_terms {
    public class Blocked_termsGetResponse_data : IAdditionalDataHolder, IParsable {
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Blocked_termsGetResponse_data"/> and sets the default values.
        /// </summary>
        public Blocked_termsGetResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="Blocked_termsGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Blocked_termsGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Blocked_termsGetResponse_data();
        }
        /// <summary>
