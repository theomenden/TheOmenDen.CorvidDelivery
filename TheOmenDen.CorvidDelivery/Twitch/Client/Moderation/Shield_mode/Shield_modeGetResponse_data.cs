...
namespace TheOmenDen.CorvidDelivery.Twitch.Moderation.Shield_mode {
    public class Shield_modeGetResponse_data : IAdditionalDataHolder, IParsable {
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Shield_modeGetResponse_data"/> and sets the default values.
        /// </summary>
        public Shield_modeGetResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="Shield_modeGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Shield_modeGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Shield_modeGetResponse_data();
        }
        /// <summary>
