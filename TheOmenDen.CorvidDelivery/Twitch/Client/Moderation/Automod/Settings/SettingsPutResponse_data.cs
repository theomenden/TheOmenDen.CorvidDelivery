...
namespace TheOmenDen.CorvidDelivery.Twitch.Moderation.Automod.Settings {
    public class SettingsPutResponse_data : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="SettingsPutResponse_data"/> and sets the default values.
        /// </summary>
        public SettingsPutResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="SettingsPutResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static SettingsPutResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SettingsPutResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"overall_level", n => { OverallLevel = n.GetDoubleValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteDoubleValue("overall_level", OverallLevel);
