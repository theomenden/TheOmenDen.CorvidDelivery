...
namespace TheOmenDen.CorvidDelivery.Twitch.Moderation.Unban_requests {
    public class Unban_requestsGetResponse_data : IAdditionalDataHolder, IParsable {
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Unban_requestsGetResponse_data"/> and sets the default values.
        /// </summary>
        public Unban_requestsGetResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="Unban_requestsGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Unban_requestsGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Unban_requestsGetResponse_data();
        }
        /// <summary>
