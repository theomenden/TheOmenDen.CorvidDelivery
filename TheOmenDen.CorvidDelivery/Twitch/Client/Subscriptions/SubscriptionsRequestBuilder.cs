...
using System;
using TheOmenDen.CorvidDelivery.Twitch.Subscriptions.User;
namespace TheOmenDen.CorvidDelivery.Twitch.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder : BaseRequestBuilder {
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/subscriptions{?after*,before*,broadcaster_id*,first*,user_id*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="SubscriptionsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubscriptionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/subscriptions{?after*,before*,broadcaster_id*,first*,user_id*}", rawUrl) {
        }
        /// <summary>
