...
namespace TheOmenDen.CorvidDelivery.Twitch.Predictions {
    public class PredictionsGetResponse_data : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<PredictionsGetResponse_data_outcomes>? Outcomes { get; set; }
#nullable restore
#else
        public List<PredictionsGetResponse_data_outcomes> Outcomes { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="PredictionsGetResponse_data"/> and sets the default values.
        /// </summary>
        public PredictionsGetResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="PredictionsGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PredictionsGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PredictionsGetResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"outcomes", n => { Outcomes = n.GetCollectionOfObjectValues<PredictionsGetResponse_data_outcomes>(PredictionsGetResponse_data_outcomes.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<PredictionsGetResponse_data_outcomes>("outcomes", Outcomes);
