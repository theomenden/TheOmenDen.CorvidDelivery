...
namespace TheOmenDen.CorvidDelivery.Twitch.Tags.Streams {
    public class StreamsGetResponse_data_localization_descriptions : IAdditionalDataHolder, IParsable {
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="StreamsGetResponse_data_localization_descriptions"/> and sets the default values.
        /// </summary>
        public StreamsGetResponse_data_localization_descriptions() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="StreamsGetResponse_data_localization_descriptions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static StreamsGetResponse_data_localization_descriptions CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new StreamsGetResponse_data_localization_descriptions();
        }
        /// <summary>
