...
namespace TheOmenDen.CorvidDelivery.Twitch.Charity.Donations {
    /// <summary>
    /// Builds and executes requests for operations under \charity\donations
    /// </summary>
    public class DonationsRequestBuilder : BaseRequestBuilder {
        ...
        public DonationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/charity/donations{?after*,broadcaster_id*,first*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="DonationsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DonationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/charity/donations{?after*,broadcaster_id*,first*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<DonationsGetResponse> GetAsDonationsGetResponseAsync(Action<RequestConfiguration<DonationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DonationsGetResponse>(requestInfo, DonationsGetResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets the list of donations that users have made to the broadcaster’s active charity campaign.
        /// </summary>
...
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<DonationsResponse>(requestInfo, DonationsResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets the list of donations that users have made to the broadcaster’s active charity campaign.
        /// </summary>
