...
namespace TheOmenDen.CorvidDelivery.Twitch.Charity.Campaigns {
    /// <summary>
    /// Builds and executes requests for operations under \charity\campaigns
    /// </summary>
    public class CampaignsRequestBuilder : BaseRequestBuilder {
        ...
        public CampaignsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/charity/campaigns{?broadcaster_id*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="CampaignsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CampaignsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/charity/campaigns{?broadcaster_id*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<CampaignsGetResponse> GetAsCampaignsGetResponseAsync(Action<RequestConfiguration<CampaignsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<CampaignsGetResponse>(requestInfo, CampaignsGetResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets information about the broadcaster’s active charity campaign.
        /// </summary>
...
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<CampaignsResponse>(requestInfo, CampaignsResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets information about the broadcaster’s active charity campaign.
        /// </summary>
