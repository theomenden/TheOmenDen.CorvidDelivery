...
#nullable enable
        public List<UsersGetResponse_data>? Data { get; set; }
#nullable restore
#else
        public List<UsersGetResponse_data> Data { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<UsersGetResponse_data>(UsersGetResponse_data.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<UsersGetResponse_data>("data", Data);
