...
namespace TheOmenDen.CorvidDelivery.Twitch.Chat.Badges.Global {
    public class GlobalGetResponse_data_versions : IAdditionalDataHolder, IParsable {
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="GlobalGetResponse_data_versions"/> and sets the default values.
        /// </summary>
        public GlobalGetResponse_data_versions() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="GlobalGetResponse_data_versions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static GlobalGetResponse_data_versions CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GlobalGetResponse_data_versions();
        }
        /// <summary>
