...
namespace TheOmenDen.CorvidDelivery.Twitch.Chat.Settings {
    public class SettingsPatchResponse_data : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? FollowerModeDuration { get; set; }
#nullable restore
#else
        public string FollowerModeDuration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? NonModeratorChatDelayDuration { get; set; }
#nullable restore
#else
        public string NonModeratorChatDelayDuration { get; set; }
#endif
        ...
        public double? SlowModeWaitTime { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="SettingsPatchResponse_data"/> and sets the default values.
        /// </summary>
        public SettingsPatchResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="SettingsPatchResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static SettingsPatchResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SettingsPatchResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"follower_mode_duration", n => { FollowerModeDuration = n.GetStringValue(); } },
                {"moderator_id", n => { ModeratorId = n.GetStringValue(); } },
                {"non_moderator_chat_delay", n => { NonModeratorChatDelay = n.GetBoolValue(); } },
                {"non_moderator_chat_delay_duration", n => { NonModeratorChatDelayDuration = n.GetStringValue(); } },
                {"slow_mode", n => { SlowMode = n.GetBoolValue(); } },
                {"slow_mode_wait_time", n => { SlowModeWaitTime = n.GetDoubleValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("follower_mode_duration", FollowerModeDuration);
            writer.WriteStringValue("moderator_id", ModeratorId);
            writer.WriteBoolValue("non_moderator_chat_delay", NonModeratorChatDelay);
            writer.WriteStringValue("non_moderator_chat_delay_duration", NonModeratorChatDelayDuration);
            writer.WriteBoolValue("slow_mode", SlowMode);
            writer.WriteDoubleValue("slow_mode_wait_time", SlowModeWaitTime);
