...
namespace TheOmenDen.CorvidDelivery.Twitch.Chat.Emotes.Set {
    public class SetGetResponse_data_images : IAdditionalDataHolder, IParsable {
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="SetGetResponse_data_images"/> and sets the default values.
        /// </summary>
        public SetGetResponse_data_images() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="SetGetResponse_data_images"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static SetGetResponse_data_images CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SetGetResponse_data_images();
        }
        /// <summary>
