...
namespace TheOmenDen.CorvidDelivery.Twitch.Chat.Emotes.User {
    /// <summary>
    /// Builds and executes requests for operations under \chat\emotes\user
    /// </summary>
    public class UserRequestBuilder : BaseRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chat/emotes/user{?after*,broadcaster_id*,user_id*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="UserRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chat/emotes/user{?after*,broadcaster_id*,user_id*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<UserGetResponse?> GetAsUserGetResponseAsync(Action<RequestConfiguration<UserRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UserGetResponse> GetAsUserGetResponseAsync(Action<RequestConfiguration<UserRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<UserResponse>(requestInfo, UserResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// BETA Retrieves emotes available to the user across all channels.
        /// </summary>
