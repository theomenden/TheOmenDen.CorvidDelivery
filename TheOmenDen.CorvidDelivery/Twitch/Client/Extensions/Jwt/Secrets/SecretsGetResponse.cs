...
#nullable enable
        public List<SecretsGetResponse_data>? Data { get; set; }
#nullable restore
#else
        public List<SecretsGetResponse_data> Data { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<SecretsGetResponse_data>(SecretsGetResponse_data.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<SecretsGetResponse_data>("data", Data);
