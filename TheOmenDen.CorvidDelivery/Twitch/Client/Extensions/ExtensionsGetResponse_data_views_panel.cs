...
namespace TheOmenDen.CorvidDelivery.Twitch.Extensions {
    public class ExtensionsGetResponse_data_views_panel : IAdditionalDataHolder, IParsable {
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ExtensionsGetResponse_data_views_panel"/> and sets the default values.
        /// </summary>
        public ExtensionsGetResponse_data_views_panel() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="ExtensionsGetResponse_data_views_panel"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ExtensionsGetResponse_data_views_panel CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ExtensionsGetResponse_data_views_panel();
        }
        /// <summary>
