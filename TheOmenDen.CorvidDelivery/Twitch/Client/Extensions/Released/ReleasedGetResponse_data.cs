...
namespace TheOmenDen.CorvidDelivery.Twitch.Extensions.Released {
    public class ReleasedGetResponse_data : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ReleasedGetResponse_data_icon_urls? IconUrls { get; set; }
#nullable restore
#else
        public ReleasedGetResponse_data_icon_urls IconUrls { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ReleasedGetResponse_data_views? Views { get; set; }
#nullable restore
#else
        public ReleasedGetResponse_data_views Views { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="ReleasedGetResponse_data"/> and sets the default values.
        /// </summary>
        public ReleasedGetResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="ReleasedGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ReleasedGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ReleasedGetResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"icon_urls", n => { IconUrls = n.GetObjectValue<ReleasedGetResponse_data_icon_urls>(ReleasedGetResponse_data_icon_urls.CreateFromDiscriminatorValue); } },
                ...
                {"views", n => { Views = n.GetObjectValue<ReleasedGetResponse_data_views>(ReleasedGetResponse_data_views.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ReleasedGetResponse_data_icon_urls>("icon_urls", IconUrls);
            ...
            writer.WriteObjectValue<ReleasedGetResponse_data_views>("views", Views);
