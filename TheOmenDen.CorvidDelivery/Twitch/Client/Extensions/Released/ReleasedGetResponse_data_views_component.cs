...
namespace TheOmenDen.CorvidDelivery.Twitch.Extensions.Released {
    public class ReleasedGetResponse_data_views_component : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ReleasedGetResponse_data_views_component"/> and sets the default values.
        /// </summary>
        public ReleasedGetResponse_data_views_component() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="ReleasedGetResponse_data_views_component"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ReleasedGetResponse_data_views_component CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ReleasedGetResponse_data_views_component();
        }
        /// <summary>
