...
namespace TheOmenDen.CorvidDelivery.Twitch.Analytics.Extensions {
    /// <summary>
    /// Builds and executes requests for operations under \analytics\extensions
    /// </summary>
    public class ExtensionsRequestBuilder : BaseRequestBuilder {
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/analytics/extensions{?after*,ended_at*,extension_id*,first*,started_at*,type*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="ExtensionsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExtensionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/analytics/extensions{?after*,ended_at*,extension_id*,first*,started_at*,type*}", rawUrl) {
        }
        /// <summary>
