...
namespace TheOmenDen.CorvidDelivery.Twitch.Bits.Leaderboard {
    public class LeaderboardGetResponse_data : IAdditionalDataHolder, IParsable {
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="LeaderboardGetResponse_data"/> and sets the default values.
        /// </summary>
        public LeaderboardGetResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="LeaderboardGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static LeaderboardGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LeaderboardGetResponse_data();
        }
        /// <summary>
