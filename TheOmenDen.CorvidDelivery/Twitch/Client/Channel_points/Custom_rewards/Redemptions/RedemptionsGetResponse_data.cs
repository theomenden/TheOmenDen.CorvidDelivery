...
namespace TheOmenDen.CorvidDelivery.Twitch.Channel_points.Custom_rewards.Redemptions {
    public class RedemptionsGetResponse_data : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RedemptionsGetResponse_data_reward? Reward { get; set; }
#nullable restore
#else
        public RedemptionsGetResponse_data_reward Reward { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="RedemptionsGetResponse_data"/> and sets the default values.
        /// </summary>
        public RedemptionsGetResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="RedemptionsGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static RedemptionsGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new RedemptionsGetResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"reward", n => { Reward = n.GetObjectValue<RedemptionsGetResponse_data_reward>(RedemptionsGetResponse_data_reward.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<RedemptionsGetResponse_data_reward>("reward", Reward);
