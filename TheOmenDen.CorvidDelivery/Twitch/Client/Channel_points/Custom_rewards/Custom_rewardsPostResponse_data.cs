...
namespace TheOmenDen.CorvidDelivery.Twitch.Channel_points.Custom_rewards {
    public class Custom_rewardsPostResponse_data : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Custom_rewardsPostResponse_data_default_image? DefaultImage { get; set; }
#nullable restore
#else
        public Custom_rewardsPostResponse_data_default_image DefaultImage { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Custom_rewardsPostResponse_data_global_cooldown_setting? GlobalCooldownSetting { get; set; }
#nullable restore
#else
        public Custom_rewardsPostResponse_data_global_cooldown_setting GlobalCooldownSetting { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Custom_rewardsPostResponse_data_max_per_stream_setting? MaxPerStreamSetting { get; set; }
#nullable restore
#else
        public Custom_rewardsPostResponse_data_max_per_stream_setting MaxPerStreamSetting { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Custom_rewardsPostResponse_data_max_per_user_per_stream_setting? MaxPerUserPerStreamSetting { get; set; }
#nullable restore
#else
        public Custom_rewardsPostResponse_data_max_per_user_per_stream_setting MaxPerUserPerStreamSetting { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Custom_rewardsPostResponse_data"/> and sets the default values.
        /// </summary>
        public Custom_rewardsPostResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="Custom_rewardsPostResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Custom_rewardsPostResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Custom_rewardsPostResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"default_image", n => { DefaultImage = n.GetObjectValue<Custom_rewardsPostResponse_data_default_image>(Custom_rewardsPostResponse_data_default_image.CreateFromDiscriminatorValue); } },
                {"global_cooldown_setting", n => { GlobalCooldownSetting = n.GetObjectValue<Custom_rewardsPostResponse_data_global_cooldown_setting>(Custom_rewardsPostResponse_data_global_cooldown_setting.CreateFromDiscriminatorValue); } },
                ...
                {"max_per_stream_setting", n => { MaxPerStreamSetting = n.GetObjectValue<Custom_rewardsPostResponse_data_max_per_stream_setting>(Custom_rewardsPostResponse_data_max_per_stream_setting.CreateFromDiscriminatorValue); } },
                {"max_per_user_per_stream_setting", n => { MaxPerUserPerStreamSetting = n.GetObjectValue<Custom_rewardsPostResponse_data_max_per_user_per_stream_setting>(Custom_rewardsPostResponse_data_max_per_user_per_stream_setting.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Custom_rewardsPostResponse_data_default_image>("default_image", DefaultImage);
            writer.WriteObjectValue<Custom_rewardsPostResponse_data_global_cooldown_setting>("global_cooldown_setting", GlobalCooldownSetting);
            ...
            writer.WriteObjectValue<Custom_rewardsPostResponse_data_max_per_stream_setting>("max_per_stream_setting", MaxPerStreamSetting);
            writer.WriteObjectValue<Custom_rewardsPostResponse_data_max_per_user_per_stream_setting>("max_per_user_per_stream_setting", MaxPerUserPerStreamSetting);
