...
namespace TheOmenDen.CorvidDelivery.Twitch.Polls {
    public class PollsGetResponse_data : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<PollsGetResponse_data_choices>? Choices { get; set; }
#nullable restore
#else
        public List<PollsGetResponse_data_choices> Choices { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="PollsGetResponse_data"/> and sets the default values.
        /// </summary>
        public PollsGetResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="PollsGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PollsGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PollsGetResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"choices", n => { Choices = n.GetCollectionOfObjectValues<PollsGetResponse_data_choices>(PollsGetResponse_data_choices.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<PollsGetResponse_data_choices>("choices", Choices);
