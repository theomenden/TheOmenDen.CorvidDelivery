...
namespace TheOmenDen.CorvidDelivery.Twitch.Polls {
    public class PollsPatchResponse_data : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<PollsPatchResponse_data_choices>? Choices { get; set; }
#nullable restore
#else
        public List<PollsPatchResponse_data_choices> Choices { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="PollsPatchResponse_data"/> and sets the default values.
        /// </summary>
        public PollsPatchResponse_data() {
            AdditionalData = new Dictionary<string, object>();
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="PollsPatchResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PollsPatchResponse_data CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PollsPatchResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"choices", n => { Choices = n.GetCollectionOfObjectValues<PollsPatchResponse_data_choices>(PollsPatchResponse_data_choices.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<PollsPatchResponse_data_choices>("choices", Choices);
